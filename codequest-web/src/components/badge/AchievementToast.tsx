...
export default function AchievementToast({ achievement, onClose }: AchievementToastProps) {
  ...
  useEffect(() => {
    ...
    try { const stored = localStorage.getItem('codequest_achievement_notify'); if (stored !== null) { const v = JSON.parse(stored); notifyEnabled = typeof v === 'boolean' ? v : true } } catch { /* default on */ }
