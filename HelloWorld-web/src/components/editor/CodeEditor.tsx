...
export default function CodeEditor({
  ...
  const fontSize = loadSetting<number>('helloworld_editor_font_size', 14)
  ...
  const handleMount: OnMount = (editor, monaco) => {
    ...
    // 自定义主题
    monaco.editor.defineTheme('HelloWorld-dark', {
      base: 'vs-dark',
      inherit: true,
      rules: [],
      colors: {
    ...
    monaco.editor.defineTheme('HelloWorld-light', {
      base: 'vs',
      inherit: true,
      rules: [],
      colors: {
    ...
    const theme = loadSetting<string>('helloworld_theme', 'dark')
    monaco.editor.setTheme(theme === 'light' ? 'HelloWorld-light' : 'HelloWorld-dark')
